...
# Command: /onyx-pr-review
# Description: Comprehensive PR review for aderant/onyx-ui with Azure DevOps integration
# Usage: /onyx-pr-review <PR_NUMBER>
...
prompt: |
  You are performing a comprehensive code review for PR #$ARGUMENTS from aderant/onyx-ui repository.
  ...
  1. Get PR details:
     - Use github_get_pull_request with owner="aderant", repo="onyx-ui", pull_number=$ARGUMENTS
  ...
  - @aderant/onyx-intake-api-client integration
  - Any new npm packages in package.json
  ...
  - Language-specific idioms (TypeScript, React)
  ...
  - Check if ./devops/onyx-ui/pr-reviews/ exists
  - Create directory with: mkdir -p ./devops/onyx-ui/pr-reviews/
  ...
  *This review was generated by OpenCode AI using Claude Sonnet 4.5, with assistance from GitHub MCP, Azure DevOps MCP, Context7, and Sequential Thinking analysis. Manual verification and human judgment should be applied before acting on any recommendations.*
  ...
  Save the report to: ./devops/onyx-ui/pr-reviews/$ARGUMENTS-review.md
  ...
  - local source code repo is located within the './onyx-ui' directory
